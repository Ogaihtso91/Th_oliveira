...
/**
 * Notifica os usuários responsáveis pela tecnologia social quando um comentário realizado é excluído pela FBB
 */
class SocialTecnologyCommentRefused extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('PLATAFORMA DE TECNOLOGIAS SOCIAIS – Comentário na Tecnologia Social Recusado ')
            ->markdown('mail._notifications._socialtecnologycommentrefused', [
