            ...
            <div class="panel panel-default">
                ...
                <form role="form" method="POST" action="/admin/baixa/inserir">
                    ...
                    <div class="box-body">
                        ...
                        <input type="hidden" value="" name="uduarioId">
                            ...
                            <div class="produto-item form-group well col-lg-12" id="ProdutoModel">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <label class="input-inline">
                                        <select class="input-inline form-control produto-estoque" name="produto[:index:][id]"  data-produto-index="<?= $key ?>">
                                            <?php foreach($produtos as $key => $produto): ?>
                                            <option value="<?= $produto->getProduto()->getId(); ?>" data-valor="<?= $produto->getValor(); ?>" data-qtd="<?= $produto->getQtdDisponivel() ?>"><?= $produto->getProduto()->getNome(); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </label>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <?php
                                    /* Aplicando a regra de valor + porcentagem */

                                    //var_dump($produto->getLucro()/100);die;
                                    //var_dump(html_escape($produto->getValor()));die;

                                    $valorAjustado = $produto->getValor() + ($produto->getValor() * ($produto->getLucro()/100));

                                    ?>

                                    <label>Valor</label>
                                    <label class="input-inline" >
                                        <input type="text" value="" class="form-control" class="valor" name="produto[:index:][valor]"  required onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                    </label>
                                </div>
                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-2">
                                    <label>Total parcial: </label> R$ 50,35
