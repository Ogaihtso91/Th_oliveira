...
class ConselhoFiscalController extends Controller
{
    ...
    public function salvar(Request $req)
    {
        ...
        event::create(['titulo' => 'Conselho Fiscal', 'data_inicial' => $event['data'], 'data_final' => $event['data'],
        'reuniao_id' => $event['id']]);
	   	return redirect()->route('admin.conselho-fiscal')->with('message', 'Reunião adicionada com sucesso.');
    }
    ...
    public function deletar($id)
    {
        ...
        reuniao::find($id)->delete();
       	return redirect()->route('admin.conselho-fiscal')->with('message', 'Reunião excluída com sucesso.');
    }
    ...
    public function atualizar(Request $req, $id)
    {
        ...
        $event->save();
        return redirect()->route('admin.conselho-fiscal')->with('message', 'Reunião atualizada com sucesso.');
	}
    ...
    public function salvarTopicos(Request $request){
        ...
        $dados = $request->all();
     	...
     	topico::create($dados);
     	return redirect()->route('admin.conselho-fiscal.visualizartopicos',$id_conselho)->with('message', 'Tópico adicionado com sucesso.');
    ...
    public function editarDocumentos($id)
    {
        ...
        return view('admin.conselho-fiscal.editar-documentos', compact('registro','topico'));
    }
    ...
    public function atualizarDocumentos(Request $request, $id)
    {
        ...
        return redirect()->route('admin.conselho-fiscal.visualizar-documentos', $id_topico)->with('message', 'Documento atualizado com sucesso.');
    }
	...
	public function salvarDocumentos(Request $request){
        ...
        $id_topico = $dados['topico_id'];
     	...
     	return redirect()->route('admin.conselho-fiscal.visualizar-documentos', $id_topico)->with('message', 'Documento adicionado com sucesso.');
    }
    ...
    public function visualizarDocumentos($id)
    {
    	...
    	return view("admin.conselho-fiscal.visualizar-documentos", compact("topico", "documentos", "url_previous"));
